...
static const Rule rules[] = {
	 ...
	 */
        ...
        { "jetbrains-clion",       NULL,     NULL,           1 << 2,     0,          0,           -1,       -1 },
        { "jetbrains-idea",        NULL,     NULL,           1 << 1,     0,          0,           -1,       -1 },
        { "leagueclientux.exe",    NULL,     NULL,           1,          1,          0,           -1,       -1 },
        { "league of legends.exe", NULL,     NULL,           1,          1,          0,           -1,       -1 },
        { "trackmania.exe",        NULL,     NULL,           1,          1,          0,           -1,       -1 },
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-F", "-c", "-l", "15", NULL };
